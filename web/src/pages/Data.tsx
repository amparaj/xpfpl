...
select * from '${repo ? repo.replace("github.com", "raw.githubusercontent.com") + "/main" : "…"}/archive/fpl/2025-26/gws.parquet' limit 10;`}</pre>
      ...
      <ul>
        ...
        <li>Odds: <a href="https://polymarket.com">Polymarket</a>. Upcoming matches on the Markets page are fetched from its public API every 5 minutes around each gameweek, every 3 hours otherwise.</li>
      </ul>
    </>
  );
}
